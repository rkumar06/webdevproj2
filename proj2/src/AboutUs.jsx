                ...
                <div className = "about-hire-us">
                    ...
                    <div className = "about-hire-us-pic-paragraph">
                        ...
                        <div className = "about-hire-info">
                            ...
                            <br/>
                            <p className = "about-hire-us-text">Please e-mail our business manager at noteworthy@ucchoral.berkeley.edu and fill out this <a className = "about-form" href="https://forms.gle/8d4TJZrQ7eX4oSbz8" target="_blank" rel="noopener noreferrer">form</a>. Then we’ll respond to you with a quote as soon as possible. In your email, let us know: Who you are, the details of the event (where and when it’ll be), what kind of songs you’d like us to perform and how long the performance should be.</p>
                        </div>
                    </div>
